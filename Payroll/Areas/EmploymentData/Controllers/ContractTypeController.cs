...
namespace Payroll.Areas.EmploymentData.Controllers
{
    ...
    public class ContractTypeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Retired")] ContractType contractType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Retired")] ContractType contractType)
        {
